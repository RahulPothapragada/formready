...
import { classifyField, extractFieldSignals } from '../extension/src/fieldClassifier';
import { fieldRequiresPdfConversion } from '../extension/src/formatConvertRule';
import { fillSelectByBestMatch } from '../extension/src/reactSafeFill';
import type { ProfileFieldKey } from '../extension/src/profile';
...
function loadForm(): Document {
  const html = readFileSync('extension/demo-portals/full-application-form.html', 'utf-8');
